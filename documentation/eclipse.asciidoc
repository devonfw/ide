...
|`import «type» [«path/url»]`   |import `mvn`/`plain` projects from the current working directory or a given path, or clone and subsequently import them from a given Git remote URL
|=======================
