...
In your link:settings.asciidoc[settings] git repository create a folder https://github.com/devonfw/ide-settings/tree/master/eclipse/plugins[eclipse/plugins] (click this link to see more examples and see which plugins come by default).
...
If your cursor is located as such a word you can hit `[Ctrl][1]` to get a context menu with additional options.
