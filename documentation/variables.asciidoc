...
MVN_VERSION=3.9.*
```
This will always install the latest stable version matching the according version.
As IDE-admin please take responsibility and choose wisely between stability and getting the latest fixes and security updates.
