...
=== Platforms
Some of the major platforms supported by `devon` are:
...
Here are the list of platforms which `devon` supprts currently.

https://github.com/devonfw/ide/tree/master/scripts/src/main/resources/scripts/command
