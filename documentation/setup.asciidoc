...
The latest release can be downloaded from https://repo.maven.apache.org/maven2/com/devonfw/tools/ide/devonfw-ide-scripts/3.2.3/devonfw-ide-scripts-3.2.3.tar.gz[here].
