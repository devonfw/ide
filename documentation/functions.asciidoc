...
=== doDownload
Selects doDownloadUrl or doDownloadMirror depending on whether the urls directory exists or not
...
=== doDownloadUrl
Same functionality as doDownloadMirror except that it uses urls instead of mirrors
