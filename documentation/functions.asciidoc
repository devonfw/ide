...
=== doCreatePostMessageFile
Creates a shell script for a message to be displayed, specifying the processing area in which the message was created, to enable the message to be output at a defined point in time.
...
=== doCheckGitVersion
Determines whether there is an security issue with the active git version, listed in the security file.

=== doCheckToolSecurityVersion
Determines whether the version is contained in the security file for the corresponding tool.
