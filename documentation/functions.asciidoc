...
Determines the latest available version of a software and write it in the variable "latest_version".
...
Determines the currently in the environment configured edition of a software and write it in the variable "edition".
