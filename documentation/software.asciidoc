...
However, to be platform independent and allow lightweight updates, the `devonfw-ide` is capable to download and link:setup.asciidoc[install] the software automatically for you.
