...
First steps regarding forks or cloning of repos and creating branches, as well as some git commands, can be found inside https://github.com/firstcontributions/first-contributions[ this first contributions guideline].
 To contribute code or text regarding the devonfw-ide at first you need to fork the https://github.com/devonfw/ide[project IDE] and then you can clone your fork into the folder `workspaces` in your devonfw-ide installation. For this the https://github.com/firstcontributions/first-contributions[first contributions guideline] can be very helpful.
