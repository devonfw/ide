...
----
/settings
├──/ https://github.com/devonfw/devon-ide-settings/tree/master/devon[devon]
│  ├──/ https://github.com/devonfw/devon-ide-settings/tree/master/devon/conf[conf]
│  │  ├──/ https://github.com/devonfw/devon-ide-settings/tree/master/devon/.m2[.m2]
│  │  │  └── https://github.com/devonfw/devon-ide-settings/blob/master/devon/.m2/settings.xml[settings.xml]
│  │  ├──/ https://github.com/devonfw/devon-ide-settings/tree/master/devon/npm[npm]
│  │  │  └── https://github.com/devonfw/devon-ide-settings/blob/master/devon/npm/.npmrc[.npmrc]
│  │  └── https://github.com/devonfw/devon-ide-settings/blob/master/devon/conf/devon.properties[devon.properties]
├──/ https://github.com/devonfw/devon-ide-settings/tree/master/eclipse[eclipse]
│  ├──/ https://github.com/devonfw/devon-ide-settings/tree/master/eclipse/workspace[workspace]
│  │  ├──/ https://github.com/devonfw/devon-ide-settings/tree/master/eclipse/workspace/setup[setup]
│  │  └──/ https://github.com/devonfw/devon-ide-settings/tree/master/eclipse/workspace/update[update]
│  ├── https://github.com/devonfw/devon-ide-settings/blob/master/eclipse/lifecycle-mapping-metadata.xml[lifecycle-mapping-metadata.xml]
│  └── https://github.com/devonfw/devon-ide-settings/blob/master/eclipse/project.dictionary[project.dictionary]
├──/ ...
├──/ https://github.com/devonfw/devon-ide-settings/tree/master/sonarqube[sonarqube]
│  └──/ https://github.com/devonfw/devon-ide-settings/tree/master/sonarqube/profiles[profiles]
│     ├── Devon-C#.xml
│     ├── ...
│     └── Devon-XML.xml
├──/ https://github.com/devonfw/devon-ide-settings/tree/master/vscode[vscode]
│  └──/ https://github.com/devonfw/devon-ide-settings/tree/master/vscode/workspace[workspace]
│     ├──/ https://github.com/devonfw/devon-ide-settings/tree/master/vscode/workspace/setup[setup]
│     └──/ https://github.com/devonfw/devon-ide-settings/tree/master/vscode/workspace/update[update]
└── https://github.com/devonfw/devon-ide-settings/blob/master/devon.properties[devon.properties]
----
