...
* *Free* +
The `devon-ide` is free just like everything from http://devonfw.com[devonfw]. See https://github.com/devonfw/ide/blob/master/TERMS_OF_USE.asciidoc[TERMS_OF_USE] for details.
