...
=== Tabs for CMD, git-bash, WSL, Powershell and more inside one window 
If you want to use different shells like CMD, Powershell, git-bash, WSL, SSH or Azure via tabs inside one window, then use https://github.com/microsoft/terminal[Windows Terminal].
