...
=== Tabs for CMD
If you want to have tabs for your windows command-line you simply install https://conemu.github.io/[ConEmu]. Here you can also add other CLIs like Putty.
Also you should have a look at the new Windows Terminal, which also has tabbed CLIs: https://github.com/Microsoft/Terminal
...
If you like a GUI to easily configure the scrips, that comes with a lot of extensions preinstalled, you should have a look at Ac'tive Aid: https://activaid.telgkamp.de/ .
...
Capture any part of your screen with a single click, directly upload to dropbox, or run an svn commit (oops sorry git ;-) ) all in one go with http://getgreenshot.org/[Greenshot]. Another screen capture tool where you can easily manage and edit your screenshots and also do screen recordings with is Screenpresso: https://www.screenpresso.com/download/
