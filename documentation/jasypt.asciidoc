...
The `jasypt` commandlet allows to install http://www.jasypt.org/[jasypt] and encrypt or decrypt secrets using strong encryption given a secure masterpassword. See also link:guide-configuration.asciidoc#password-encryption[devon4j password encryption guide] for further details.
