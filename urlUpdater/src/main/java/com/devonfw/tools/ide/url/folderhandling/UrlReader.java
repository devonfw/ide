...
/**
 * Allows to load an already existing download-urls folder structure by giving on 
 * an object of type UrlRepository, indicating where the folder structure begins. 
 */
public class UrlReader<O extends UrlArtifact> {

	  /**
	   *
	   * @param UrlRepoObject The UrlRepository object representing the folder to start 
	   * loading the folder structure for the download-urls.
	   */
