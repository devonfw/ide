...
* https://github.com/devonfw/ide/issues/803[#8ß3]: git pull not working on debug
...
The full list of changes for this release can be found in https://github.com/devonfw/ide/milestone/31?closed=1[milestone 2022.04.004].
