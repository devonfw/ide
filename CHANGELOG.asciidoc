...
* https://github.com/devonfw/ide/issues/1394[#1394]: Warning for find command

The full list of changes for this release can be found in https://github.com/devonfw/ide/milestone/52?closed=1[milestone 2024.11.002].

== 2024.11.001

Release with bugfix:

* https://github.com/devonfw/ide/issues/1391[#1391]: dependencies.json not supported - tomcat not working anymore

The full list of changes for this release can be found in https://github.com/devonfw/ide/milestone/51?closed=1[milestone 2024.11.001].
