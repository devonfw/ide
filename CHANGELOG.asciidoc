...
* https://github.com/devonfw/ide/issues/1305[#1305]: Intellij and Android Studio start scripts dont work properly (may cause a breaking change for Intellij config)
