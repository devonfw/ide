...
image:https://github.com/devonfw/ide/actions/workflows/release.yml/badge.svg["Build Status",link="https://github.com/devonfw/ide/actions/workflows/release.yml"]
