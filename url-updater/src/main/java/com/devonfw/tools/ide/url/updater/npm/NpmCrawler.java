...
public class NpmCrawler extends WebsiteCrawler {
  ...
  protected void updateVersion(UrlVersion urlVersion) {
    ...
    doUpdateVersion(urlVersion, "https://nodejs.org/dist/v${version}/node-v${version}-win-x64.zip", OSType.WINDOWS,
        "x64");
    doUpdateVersion(urlVersion, "https://nodejs.org/dist/v${version}/node-v${version}-darwin-x64.tar.gz", OSType.MAC,
        "x64");
    doUpdateVersion(urlVersion, "https://nodejs.org/dist/v${version}/node-v${version}.pkg", OSType.MAC, "arm64");
    doUpdateVersion(urlVersion, "https://nodejs.org/dist/v${version}/node-v${version}-linux-x64.tar.xz", OSType.LINUX,
        "x64");
  }
