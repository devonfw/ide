 ...
 * <p>
 * This class provides functionality for crawling a website and extracting the available version numbers
 * by matching a pattern in the website HTML body.
 * <p>
 * Concrete subclasses of this class must implement the getVersionPattern and getVersionUrl methods to
