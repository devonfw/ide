 ...
 */
public abstract class AbstractUrlFolderWithParent<P extends AbstractUrlFolder<?>, C extends UrlArtifactWithParent<?>> extends AbstractUrlFolder<C> implements UrlArtifactWithParent<P> {
