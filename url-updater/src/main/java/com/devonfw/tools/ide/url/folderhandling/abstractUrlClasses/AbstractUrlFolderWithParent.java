...
/**
 *
 * Class from which UrlTool, UrlEdition and UrlVersion inherit, as their objects
 * have both parent and eventually child objects. It mainly gives methods to
 * read a parent object or to create or read child objects.
 *
