...
public class KotlinNativeCrawler extends WebsiteCrawler {
  ...
  protected void updateVersion(UrlVersion urlVersion) {
    ...
    doUpdateVersion(urlVersion,
        "https://github.com/JetBrains/kotlin/releases/download/v${version}/kotlin-native-windows-x86_64-${version}.zip",
        OSType.WINDOWS, "x64");
    doUpdateVersion(urlVersion,
        "https://github.com/JetBrains/kotlin/releases/download/v${version}/kotlin-native-linux-x86_64-${version}.tar.gz",
        OSType.LINUX, "x64");
    doUpdateVersion(urlVersion,
        "https://github.com/JetBrains/kotlin/releases/download/v${version}/kotlin-native-macos-x86_64-${version}.tar.gz",
        OSType.MAC, "x64");
    doUpdateVersion(urlVersion,
