...
public class UrlEditorTest {
	...
	public void test() throws IOException {
		...
		assertThat(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getName()).isEqualTo(version);
		...
		assertThat(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild("urls").getName()).isEqualTo("urls");
		...
		assertThat(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild(os + ".urls").getName()).isEqualTo(os + ".urls");
		...
		assertThat(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild(os + "_" + arch + ".urls").getName()).isEqualTo(os + "_" + arch + ".urls");


		assertThat(urlEditorObject.getFolder(tool).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool)));
		assertThat(urlEditorObject.getFolder(tool, edition).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition)));
		assertThat(urlEditorObject.getFolder(tool, edition, version).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version)));
		assertThat(urlEditorObject.getFile(tool, edition, version).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild("urls")));
		assertThat(urlEditorObject.getFile(tool, edition, version, os).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild(os + ".urls")));
		assertThat(urlEditorObject.getFile(tool, edition, version, os, arch).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild(os + "_" + arch + ".urls")));
		assertThat(urlEditorObject.getFile(tool, edition, version, os, arch).equals(urlEditorObject.getUrlRepositoryObject().getChild(tool).getChild(edition).getChild(version).getChild(os + "_" + arch + ".urls")));
		...
		assertThat(fileNamedUrls.getObjectsList()).contains(urlToAdd);
		ArrayList<String> fileContentAfterAdd = fileNamedUrls.debugLoadFileContent();
		assertThat(fileNamedUrls.getObjectsList()).isEqualTo(fileContentAfterAdd);
		...
		assertThat(fileNamedUrls.getObjectsList()).isEqualTo(fileContentAfterRemoval);
		...
		assertThat(fileNamedUrls.getObjectsList()).isEqualTo(fileContentAfterListAdd);
